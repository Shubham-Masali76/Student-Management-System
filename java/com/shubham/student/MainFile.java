        ...
        while (runningLoop) {
            ...
            switch (choice) {
                case 1:
                    ...
                    new StudentDBLogger("Added student: " + name).start();
                ...
                case 3:
                    ...
                    Student found = manager.getStudentById(searchId);
                ...
                case 4:
                    ...
                    if (updated) {
                        ...
                        new StudentDBLogger("Updated student ID: " + updateId).start();
                    } 
                ...
                case 5:
                    ...
                    if (deleted) {
                        ...
                        new StudentDBLogger("Deleted student ID: " + deleteId).start();
                    } 
